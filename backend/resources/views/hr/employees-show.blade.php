    ...
    <div x-show="!loading" x-cloak>
        ...
        <div class="ed-hero">
            <div class="flex items-start justify-between gap-4 relative" style="z-index:1">
                ...
                <div class="flex items-center gap-2 flex-shrink-0">
                    <button x-show="hasPerm('hr.employees.edit')" @click="openEdit()" class="ed-hdr-btn">
                    ...
                    <button x-show="hasPerm('hr.employees.delete')" @click="deleteEmployee()" class="ed-hdr-btn-del" title="Delete employee">
        ...
        <div x-show="activeTab === 'documents'">
            <div class="flex justify-end mb-3">
                <button x-show="hasPerm('hr.employees.edit')" @click="showDocModal = true" class="btn-primary inline-flex items-center gap-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center gap-3">
                                            ...
                                            <button x-show="hasPerm('hr.employees.edit')" @click="deleteDocument(doc)" class="text-red-500 hover:text-red-700 text-sm font-medium">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            </template>
        ...
        <div x-show="activeTab === 'payroll'" class="space-y-5">
            ...
            <div class="card p-0 overflow-visible rounded-2xl">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <button x-show="hasPerm('hr.salary_components.create')" @click="showComponentModal = true" class="btn-primary text-xs px-3 py-1.5">Add Component</button>
                </div>
                <div class="overflow-x-auto">
                    <table class="ed-table min-w-full">
                        ...
                        <tbody>
                            <template x-for="c in salaryComponents" :key="c.id">
                                <tr>
                                    ...
                                    <td><button x-show="hasPerm('hr.salary_components.delete')" @click="deleteSalaryComponent(c)" class="text-red-500 hover:text-red-700 text-sm">Delete</button></td>
                                </tr>
                            </template>
