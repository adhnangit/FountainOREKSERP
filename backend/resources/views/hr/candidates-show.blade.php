...
@section('page-desc', 'Application, interviews and pipeline history')
@php $sec = 'hr'; @endphp
...
<div x-data="candidateShowPage()" x-init="init()">
    ...
    <div x-show="!loading" x-cloak>
        <a href="{{ url('/hr/candidates') }}" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 mb-4 transition-colors">
