...
@section('page-desc', 'Manage your staff records')
@php $sec = 'hr'; @endphp
...
<div x-data="employeesPage()" x-init="init()">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        ...
        <div class="flex items-center gap-2">
            <button x-show="hasPerm('hr.employees.create')" @click="showImport = true" class="btn-secondary inline-flex items-center gap-2">
            ...
            <a x-show="hasPerm('hr.employees.create')" href="{{ url('/hr/employees/create') }}" class="btn-primary inline-flex items-center gap-2">
