        ...
        <div class="cd-hero">
            <div class="flex items-start justify-between gap-4 relative" style="z-index:1">
                ...
                <div class="flex items-center gap-2 flex-shrink-0">
                    ...
                    <button @click="openEdit()" x-show="hasPerm('customers.edit')" class="cd-hdr-btn">
                    ...
                    <button @click="deleteCustomer()" x-show="hasPerm('customers.delete')" class="cd-hdr-btn-del" title="Delete customer">
            ...
            <div class="cd-stat-row relative" style="z-index:1">
                <div class="cd-stat-card">
                    ...
                    <div class="flex items-end justify-between gap-2">
                        ...
                        <button x-show="(customer.balance ?? 0) > 0 && hasPerm('customers.edit')" @click="openPayModal()"
                        ...
                        <tbody>
                            <template x-for="p in obPayments" :key="p.journal_entry_id">
                                <tr :class="p.reversed ? 'opacity-50' : ''">
                                    ...
                                    <td class="text-right">
                                        <button x-show="!p.reversed && (!p.cheque || p.cheque.status === 'in_hand') && hasPerm('customers.edit')"
