...
@section('page-title', 'Bulk Payment')
@section('page-desc', 'Pay several outstanding invoices for this customer in one payment')
...
<div x-data="bulkPaymentPage()" class="px-6 pb-12">
  ...
  <div x-show="!loading" x-cloak class="flex flex-col lg:flex-row gap-6">
    ...
    <div class="lg:sticky lg:top-6 space-y-5">
      ...
      <button type="button" @click="submit()" :disabled="submitting" x-show="hasPerm('invoices.payment')"
