...
@section('page-title', 'Sales Targets')
@section('page-desc', 'Set and monitor branch & sales rep targets')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3">
      <template x-for="t in branchTargets" :key="t.id">
        <div class="tgt-card">
          ...
          {{-- Annual allocation indicator (monthly tab only) --}}
    ...
    <div class="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-lg p-6 z-10 overflow-y-auto" style="max-height:90vh">
      ...
      <div class="space-y-4">
        ...
        <template x-if="!editTarget">
          {{-- Target for: Branch or Sales Rep --}}
          <div>
        ...
        {{-- Sales Rep (only when target_for=rep) --}}
        ...
        {{-- Annual allocation hint (create mode, monthly tab only) --}}
