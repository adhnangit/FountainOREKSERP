@extends('layouts.app')
@section('title', 'Inquiry Statuses')
@section('page-title', 'Inquiries — Statuses')
@section('page-desc', 'Manage the pipeline stages used to track an inquiry from first contact to close')
...
<div x-data="inquiryStatusesPage()" x-init="init()" x-cloak>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div class="flex gap-2">
            <a href="{{ url('/inquiries') }}" class="btn-secondary text-sm">All Inquiries</a>
