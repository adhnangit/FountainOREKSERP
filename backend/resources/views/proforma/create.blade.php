...
@section('page-title', 'New Proforma Invoice')
@section('page-desc', 'Draft invoice — no stock or account impact until converted by admin')
            ...
            <div class="group px-5 py-4 hover:bg-amber-50/40 dark:hover:bg-amber-900/10 transition-colors">
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  {{-- Searchable product dropdown + Delete --}}
                  <div class="flex items-center gap-2 mb-2.5">
                    <div class="search-dd flex-1 min-w-0"
                      ...
                      <button type="button"
                              @click="open = !open; if(open){ const r=$el.getBoundingClientRect(); ddStyle='top:'+(r.bottom+4)+'px;left:'+r.left+'px;width:'+r.width+'px;'; $nextTick(() => $refs['ps_' + i]?.focus()) }"
                  ...
                  {{-- Stock indicator + over-stock warning --}}
    ...
    <div class="lg:sticky lg:top-6 space-y-5">
      ...
      <div class="card overflow-hidden">
        ...
        <div class="px-5 py-4 space-y-4">
          ...
          {{-- Branch (select first so customers filter) --}}
          <div>
          ...
          <div>
            ...
            <div class="search-dd"
                 ...
                 @keydown.escape="open = false">
              <button type="button"
                      @click="open = !open; if(open){ const r=$el.getBoundingClientRect(); ddStyle='top:'+(r.bottom+4)+'px;left:'+r.left+'px;width:'+r.width+'px;'; $nextTick(() => $refs.cSearch?.focus()) }"
                      class="input text-sm w-full text-left flex items-center justify-between gap-2"
      ...
      <div class="space-y-2.5">
        ...
        <a href="{{ url('/proforma-invoices') }}" class="btn-secondary w-full flex items-center justify-center gap-2 py-2.5 text-center">
