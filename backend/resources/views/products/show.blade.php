    ...
    <div x-show="!loading" class="pb-12">
        ...
        <div class="flex items-center justify-between mb-5">
            ...
            <div class="flex items-center gap-2">
                <a :href="BASE + '/products/' + id + '/edit'" x-show="hasPerm('products.edit')" class="btn-secondary text-sm inline-flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                    Edit
                </a>
                <button @click="confirmDelete()" x-show="hasPerm('products.delete')" class="btn-danger text-sm inline-flex items-center gap-2">
