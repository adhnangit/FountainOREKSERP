...
<div x-data="salesReturnsPage()" x-init="init()">
  ...
  <div class="sr-stats">
    <div class="sr-stat-card">
      ...
      <div>
        <div class="sr-stat-val" style="color:#4f46e5" x-text="stats.total_count"></div>
    ...
    <div class="sr-stat-card">
      ...
      <div>
        <div class="sr-stat-val" style="color:#b91c1c" x-text="fmtCompact(stats.total_amount)"></div>
    ...
    <div class="sr-stat-card">
      ...
      <div>
        <div class="sr-stat-val" style="color:#b45309" x-text="stats.this_month_count"></div>
  ...
  <div class="sr-toolbar">
    <div class="sr-search-wrap">
      ...
      <input x-model.debounce.400ms="search" @input.debounce.400ms="page=1;load()" type="text" placeholder="Search CN #, invoice # or customer…">
    </div>
    ...
    return {
        ...
        async load() {
            ...
            try {
                ...
                const r = await apiFetch('/sales-returns?' + params);
                if (!r) return;
