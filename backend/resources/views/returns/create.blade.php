...
@section('page-desc', 'Issue a credit note for returned goods')
...
<div x-data="salesReturnCreate()" x-init="init()" x-cloak>
  <div class="max-w-3xl mx-auto space-y-5">
    ...
    <div class="flex items-center gap-3">
      <a href="{{ url('/sales-returns') }}" class="text-gray-400 hover:text-gray-600 transition-colors">
    ...
    <div x-show="inv" class="card p-5 space-y-4">
      ...
      <div class="flex items-center justify-end gap-3 pt-1">
        <a href="{{ url('/sales-returns') }}" class="btn-secondary">Cancel</a>
