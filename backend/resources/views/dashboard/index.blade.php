...
@section('page-desc', 'Business performance overview')
...
<div x-data="dashboard()" x-init="init()" x-cloak>
  ...
  <div x-show="!loading" class="space-y-4">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3" x-show="widgetVisible('cheque_summary')" x-cloak>
      ...
      <a href="{{ url('/cheques') }}?direction=received&status=in_hand"
      ...
      <a href="{{ url('/cheques') }}" class="kpi-card block" style="background:linear-gradient(135deg,#0891b2,#0e7490)">
        <div class="flex items-center gap-3 px-4 py-4">
          <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style="background:rgba(255,255,255,0.16)">
            <svg style="width:18px;height:18px" class="text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>
      ...
      <a href="{{ url('/cheques') }}?direction=issued" class="kpi-card block" style="background:linear-gradient(135deg,#b45309,#92400e)">
        <div class="flex items-center gap-3 px-4 py-4">
          <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style="background:rgba(255,255,255,0.16)">
            <svg style="width:18px;height:18px" class="text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <a href="{{ url('/cheques') }}?direction=issued" class="kpi-card block" style="background:linear-gradient(135deg,#7c3aed,#5b21b6)">
        <div class="flex items-center gap-3 px-4 py-4">
          <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style="background:rgba(255,255,255,0.16)">
            <svg style="width:18px;height:18px" class="text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="!tLoading">
          ...
          <template x-if="groupedRows.length===0">
            <div class="text-center text-gray-400 py-10">
              ...
              <a href="{{ url('/targets') }}" class="block mt-1 text-blue-600 hover:underline text-sm font-medium">Set targets →</a>
            </div>
          </template>
