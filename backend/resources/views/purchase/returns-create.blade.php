...
@section('page-desc', 'Issue a debit note for goods returned to a supplier')
...
<div x-data="purchaseReturnCreate()" x-init="init()" x-cloak>
  <div class="max-w-3xl mx-auto space-y-5">
    ...
    <div class="flex items-center gap-3">
      <a href="{{ url('/purchase-returns') }}" class="text-gray-400 hover:text-gray-600 transition-colors">
    ...
    {{-- Step 1: pick the purchase order --}}
    ...
    <div x-show="po" class="card p-5 space-y-4">
      ...
      <div class="flex items-center justify-end gap-3 pt-1">
        <a href="{{ url('/purchase-returns') }}" class="btn-secondary">Cancel</a>
