...
@section('page-desc', 'Record incoming goods against a purchase order')
...
<div class="flex flex-col lg:flex-row gap-6">
  ...
  <div class="lg:sticky lg:top-6 space-y-5">
    ...
    <div class="flex gap-3">
      <a href="{{ url('/grns') }}" class="btn-secondary flex-1 text-center">Cancel</a>
