...
@section('page-desc', 'View supplier invoice details and payments')
...
<div x-data="invShowPage()" x-init="init()" class="pb-16">
  ...
  <div x-show="!loading && !po" x-cloak class="flex flex-col items-center justify-center py-32 text-gray-400">
    ...
    <a href="{{ url('/purchase-orders') }}" class="mt-3 text-sm text-indigo-600 hover:underline">Back to list</a>
  </div>
