...
@section('page-desc', 'Supplier information and purchase history')
...
<div x-data="supplierShowPage()" x-init="init()">
    ...
    <div x-show="!loading" x-cloak>
        <a href="{{ url('/suppliers') }}" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 mb-4 transition-colors">
