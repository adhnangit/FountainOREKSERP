  ...
  <div class="hidden lg:flex lg:w-1/2 xl:w-3/5 relative flex-col items-center justify-center overflow-hidden"
    ...
    <div class="relative z-10 flex flex-col items-center text-center px-12">
      <div class="rounded-3xl mb-6 shadow-2xl bg-white/95 px-8 py-5">
        <img src="{{ asset('backend/public/images/oreks-logo.png') }}" alt="OREKS" style="height:64px;width:auto;object-fit:contain" />
      </div>
  ...
  <div class="flex-1 flex items-center justify-center p-6 bg-gray-50 dark:bg-gray-900">
    <div class="w-full max-w-md">
      ...
      <div class="lg:hidden text-center mb-8">
        <img src="{{ asset('backend/public/images/oreks-logo.png') }}" alt="OREKS" class="mx-auto" style="height:44px;width:auto;object-fit:contain" />
      </div>
