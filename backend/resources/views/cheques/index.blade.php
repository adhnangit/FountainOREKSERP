...
@section('page-title', 'Cheque Register')
@section('page-desc', 'Track and manage all cheques')
...
<div x-data="chequesPage()" x-init="init()">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5">
            ...
            <div class="space-y-1.5 border-t border-gray-100 dark:border-gray-700 pt-3">
                {{-- Pending exposure: in-hand received vs in-hand issued --}}
                <div class="flex items-center justify-between text-xs">
                    ...
                    <template x-for="ch in displayed" :key="ch.id">
                        <tr>
                            ...
                            <td style="max-width:200px">
                                {{-- Supplier payments (received cheque handed to supplier) --}}
                                ...
                                {{-- Notes (set when used for supplier payment) --}}
