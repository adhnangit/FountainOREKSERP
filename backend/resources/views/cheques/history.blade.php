@extends('layouts.app')
@section('title', 'Cheque History')
@section('page-title', 'Cheque History')
@section('page-desc', 'Track the complete lifecycle of customer cheques')
...
<div x-data="chequeHistory()" x-init="init()">
    ...
    <div class="ch-hero mb-5">
        ...
        <div class="ch-hero-content">
            <div class="flex items-start justify-between flex-wrap gap-4">
                ...
                {{-- Selected customer badge (or search summary when no customer) --}}
    ...
    {{-- ── Stats Row (shown when data loaded) ── --}}
    ...
    {{-- Welcome state — shown only before first search --}}
                    ...
                    <tbody>
                        <template x-for="ch in cheques" :key="ch.id">
                            <tr>
                                ...
                                {{-- Customer (shown only in global/no-customer search) --}}
