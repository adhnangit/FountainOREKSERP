...
@section('page-desc', 'Organize services into categories')
...
<div x-data="serviceCategoriesPage()" x-init="init()" x-cloak>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        ...
        <button @click="openCreate()" x-show="hasPerm('services.create')" class="btn-primary inline-flex items-center gap-2">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20">
                            ...
                            <td class="table-td">
                                <div class="flex items-center gap-3">
                                    <button @click="openEdit(row)" x-show="hasPerm('services.edit')" class="text-sm font-medium text-indigo-600 hover:text-indigo-800">Edit</button>
                                    <button @click="deleteCategory(row)" x-show="hasPerm('services.delete')" class="text-sm font-medium text-red-500 hover:text-red-700">Delete</button>
                                </div>
                            </td>
                        </tr>
                    </template>
