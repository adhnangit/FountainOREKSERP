...
@section('page-desc', 'Manage and track all customer invoices')
            ...
            <tr>
              ...
              <td style="text-align:right">
                <div style="display:flex;align-items:center;justify-content:flex-end;gap:5px">
                  ...
                  <a :href="BASE+'/invoices/'+inv.id+'/edit'" class="inv-action-btn" title="Edit" x-show="['draft','confirmed'].includes(inv.status) && hasPerm('invoices.edit')">
