...
@section('page-desc', 'View invoice information and payment history')
    ...
    <div class="space-y-5">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex gap-2 flex-wrap">
          ...
          <template x-if="inv.status === 'draft' && hasPerm('invoices.confirm')">
          ...
          <template x-if="['confirmed','pending','partial','overdue','partially_paid'].includes(inv.status) && hasPerm('invoices.payment')">
          ...
          <template x-if="inv.status !== 'paid' && inv.status !== 'cancelled' && hasPerm('invoices.cancel')">
          ...
          <template x-if="inv.status === 'draft' && hasPerm('invoices.delete')">
