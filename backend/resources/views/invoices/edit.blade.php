...
@section('page-desc', 'Correct a draft invoice before confirming it')
...
<div x-data="invoiceEdit()" x-init="init()" class="px-6 pb-12">
  ...
  <template x-if="!loading && notFound">
    <div class="card p-12 text-center text-gray-400">
      Invoice not found.
      <div class="mt-3"><a href="{{ url('/invoices') }}" class="text-blue-600 hover:underline text-sm">Back to Invoices</a></div>
    </div>
  </template>
