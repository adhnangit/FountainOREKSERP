...
@section('page-desc', 'Create a new confirmed sales invoice')
          ...
          <div class="group px-5 py-4 hover:bg-blue-50/40 dark:hover:bg-blue-900/10 transition-colors">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1 min-w-0">
                ...
                {{-- Qty + Price + Discount + Total (hidden in multi-batch mode) --}}
                ...
                {{-- Stock indicator (single-batch mode only) --}}
  ...
  <div class="lg:sticky lg:top-6 space-y-5">
    ...
    <div class="card overflow-visible">
      ...
      <div class="px-5 py-4 space-y-4">
        ...
        {{-- Branch first (so customer list filters) --}}
        <div>
...
function invoiceCreate() {
  return {
    ...
    calcTotals() {
      ...
      // Bill-level discount, applied on top of line-item discounts — a flat
      // amount always overrides a percent when both are entered, matching
      // InvoiceController::calculateTotals() exactly (same formula, same
      // order of operations), so the frontend preview never disagrees with
      // what the backend actually saves.
