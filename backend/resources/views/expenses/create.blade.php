...
@section('page-desc', 'Record an expense against a chart of accounts account')
      ...
      <div class="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div class="search-dd" x-data="{ open: false, q: '', ddStyle: '' }" @click.away="open = false" @keydown.escape="open = false">
            <button type="button" @click="open = !open; if(open){ const r=$el.getBoundingClientRect(); ddStyle='top:'+(r.bottom+4)+'px;left:'+r.left+'px;width:'+r.width+'px;'; $nextTick(() => $refs.expAcct?.focus()) }"
          ...
          <p x-show="expenseAccounts.length === 0 && !loadingAccounts"
            ...
            <a href="{{ url('/accounting/chart-of-accounts') }}" class="underline">Chart of Accounts</a>.
          </p>
        </div>
  ...
  <div class="lg:sticky lg:top-6 space-y-5">
    ...
    <div class="card">
      ...
      <div class="px-5 py-4 space-y-4">
        ...
        {{-- BANK TRANSFER: Bank Account + Reference --}}
        ...
        {{-- CHEQUE: Party Cheque or Own Cheque --}}
        <template x-if="form.payment_method === 'cheque'">
          <div class="space-y-3">
            {{-- Cheque sub-type toggle --}}
            <div>
            ...
            {{-- Party Cheque: pick from in-hand received cheques --}}
            <template x-if="form.cheque_type === 'party'">
              <div class="space-y-3">
                ...
                {{-- Auto-credited account info (no dropdown needed) --}}
                <div class="rounded-lg px-3 py-2.5 text-xs"
                  ...
                  <template x-if="!chequeInHandAccount">
                    <div class="text-amber-700">
                      ...
                      <a href="{{ url('/accounting/chart-of-accounts') }}" class="underline font-semibold">Chart of Accounts</a>.
                    </div>
                  </template>
                </div>
              </div>
            ...
            {{-- Own Cheque: enter cheque details + bank account --}}
    ...
    <div class="flex gap-3">
      <a href="{{ url('/expenses') }}" class="btn-secondary flex-1 text-center">Cancel</a>
