...
@section('page-desc', 'Update expense details and payment information')
...
<form @submit.prevent="submit()">
  ...
  <div class="flex items-center justify-between mb-5">
    <a href="{{ url('/expenses') }}" class="inline-flex items-center gap-1.5 text-sm font-medium text-gray-500 hover:text-gray-800">
      ...
      <div class="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div class="search-dd" x-data="{ open: false, q: '', ddStyle: '' }" @click.away="open = false" @keydown.escape="open = false">
            <button type="button" @click="open = !open; if(open){ const r=$el.getBoundingClientRect(); ddStyle='top:'+(r.bottom+4)+'px;left:'+r.left+'px;width:'+r.width+'px;'; $nextTick(() => $refs.expAcctEdit?.focus()) }"
