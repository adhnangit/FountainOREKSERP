...
@section('page-desc', 'View expense information')
        ...
        <div class="space-y-5">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div class="flex gap-2 flex-wrap">
                    <template x-if="['draft','pending'].includes(exp.status) && hasPerm('expenses.create')">
                    ...
                    <template x-if="exp.status === 'pending' && hasPerm('expenses.approve')">
                    ...
                    <template x-if="exp.status !== 'approved' && hasPerm('expenses.delete')">
