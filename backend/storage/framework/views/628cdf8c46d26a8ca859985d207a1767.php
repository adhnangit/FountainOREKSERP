...
<?php $__env->startSection('page-title', 'New Service'); ?>
<?php $__env->startSection('page-desc', 'Add a billable service — equipment rental, or any other non-stock charge'); ?>
...
<div class="flex flex-col lg:flex-row gap-6">
  ...
  <div class="lg:sticky lg:top-6 space-y-5">
    ...
    <div class="flex gap-3">
      <a href="<?php echo e(url('/services')); ?>" class="btn-secondary flex-1 text-center">Cancel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\services\create.blade.php ENDPATH**/ ?>