...
<?php $__env->startSection('page-desc', 'Manage your customer accounts'); ?>
...
<div x-data="customersPage()" x-init="init()">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
        ...
        <a href="<?php echo e(url('/customers/create')); ?>" class="btn-primary inline-flex items-center gap-2 whitespace-nowrap">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views/customers/index.blade.php ENDPATH**/ ?>