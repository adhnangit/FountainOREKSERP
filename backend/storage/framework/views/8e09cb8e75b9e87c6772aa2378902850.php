...
<head>
    <meta charset="utf-8">
    <title>Payslip <?php echo e($payslip->employee->employee_code); ?></title>
    <style>
...
<body>
            ...
            <tr>
                <td style="vertical-align:top; width:56%">
                    ...
                    <div class="company-address">
                        <strong style="color:#222"><?php echo e($branch->name); ?></strong>
                        <?php if($branch->address): ?><br><?php echo e($branch->address); ?><?php endif; ?>
                    </div>
                    <?php endif; ?>
                </td>
                <td style="vertical-align:top; width:44%">
                    <div class="doc-type-label serif">Payslip</div>
                    <div class="period-label"><?php echo e($periodLabel); ?></div>
                </td>
            </tr>
        </table>
    </div>
    ...
    <table class="info-table">
        <tr>
            ...
            <td><strong><?php echo e($payslip->employee->full_name); ?></strong> (<?php echo e($payslip->employee->employee_code); ?>)</td>
            <td class="info-label">Department</td>
            <td><?php echo e($payslip->employee->department?->name ?? '—'); ?></td>
        </tr>
        <tr>
            <td class="info-label">Designation</td>
            <td><?php echo e($payslip->employee->designation?->name ?? '—'); ?></td>
            <td class="info-label">Join Date</td>
            <td><?php echo e($payslip->employee->join_date?->format('d/m/Y') ?? '—'); ?></td>
        </tr>
        <?php if($payslip->employee->bank_name): ?>
        <tr>
            <td class="info-label">Bank Account</td>
            <td colspan="3"><?php echo e($payslip->employee->bank_name); ?> <?php if($payslip->employee->bank_account_number): ?> — <?php echo e($payslip->employee->bank_account_number); ?> <?php endif; ?></td>
        </tr>
        <?php endif; ?>
    </table>
        ...
        <tr>
            <td>
                <table class="money-table">
                    ...
                    <tbody>
                        <tr><td>Basic Salary</td><td class="amt"><?php echo e(number_format($payslip->basic_salary, 2)); ?></td></tr>
                        <?php $__currentLoopData = ($payslip->components ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($c['type'] === 'allowance'): ?>
                            <tr><td><?php echo e($c['name']); ?></td><td class="amt"><?php echo e(number_format($c['amount'], 2)); ?></td></tr>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    <tfoot>
                        <tr><td>Gross Pay</td><td class="amt"><?php echo e(number_format($payslip->gross_pay, 2)); ?></td></tr>
                    </tfoot>
                </table>
            </td>
            <td>
                <table class="money-table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = ($payslip->components ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($c['type'] === 'deduction'): ?>
                            <tr><td><?php echo e($c['name']); ?></td><td class="amt"><?php echo e(number_format($c['amount'], 2)); ?></td></tr>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if($payslip->unpaid_leave_days > 0): ?>
                        <tr><td>Unpaid Leave (<?php echo e(rtrim(rtrim(number_format($payslip->unpaid_leave_days, 1), '0'), '.')); ?> day(s))</td><td class="amt"><?php echo e(number_format($payslip->unpaid_leave_deduction, 2)); ?></td></tr>
                        <?php endif; ?>
                        <?php if($payslip->epf_employee > 0): ?>
                        <tr><td>EPF Contribution (Employee 8%)</td><td class="amt"><?php echo e(number_format($payslip->epf_employee, 2)); ?></td></tr>
                        <?php endif; ?>
                    </tbody>
                    <tfoot>
                        <tr><td>Total Deductions</td><td class="amt"><?php echo e(number_format($payslip->total_deductions + $payslip->unpaid_leave_deduction + $payslip->epf_employee, 2)); ?></td></tr>
                    </tfoot>
                </table>
            </td>
        </tr>
    ...
    <div class="net-pay-box">
        ...
        <span class="val">Rs. <?php echo e(number_format($payslip->net_pay, 2)); ?></span>
        <div style="clear:both"></div>
    </div>

    <?php if($payslip->epf_employer > 0 || $payslip->etf_employer > 0): ?>
    <div class="employer-note">
        Employer contributions (not deducted from net pay): EPF <?php echo e(number_format($payslip->epf_employer, 2)); ?>, ETF <?php echo e(number_format($payslip->etf_employer, 2)); ?>.
    </div>
    <?php endif; ?>
...
<?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\pdf\payslip.blade.php ENDPATH**/ ?>