...
<head>
    <meta charset="utf-8">
    <title>Balance Sheet - <?php echo e($data['as_of']); ?></title>
    <style>
...
<body>
    ...
    <table class="columns">
        <tr>
            <td>
                ...
                <table class="data">
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $data['asset_accounts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td style="width:70%"><?php echo e($a['name']); ?></td>
                                <td class="num" style="width:30%"><?php echo e(number_format($a['balance'], 2)); ?></td>
                            </tr>
                        ...
                        <tr class="subtotal-row">
                            <td>Total Assets</td>
                            <td class="num">Rs. <?php echo e(number_format($data['total_assets'], 2)); ?></td>
                        </tr>
                    </tbody>
                </table>
            </td>
            <td>
                ...
                <table class="data">
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $data['liability_accounts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td style="width:70%"><?php echo e($a['name']); ?></td>
                                <td class="num" style="width:30%"><?php echo e(number_format($a['balance'], 2)); ?></td>
                            </tr>
                        ...
                        <tr class="subtotal-row">
                            ...
                            <td class="num">Rs. <?php echo e(number_format($data['total_liabilities'], 2)); ?></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="data">
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $data['equity_accounts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td style="width:70%"><?php echo e($a['name']); ?></td>
                                <td class="num" style="width:30%"><?php echo e(number_format($a['balance'], 2)); ?></td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td class="num" style="width:30%"><?php echo e(number_format($data['retained_earnings'], 2)); ?></td>
                        </tr>
                        <tr class="subtotal-row">
                            <td>Total Equity</td>
                            <td class="num">Rs. <?php echo e(number_format($data['total_equity'] + $data['retained_earnings'], 2)); ?></td>
                        </tr>
                    </tbody>
                </table>
            </td>
    ...
    <table class="grand-table">
        <tr>
            ...
            <td class="num" style="width:50%">Rs. <?php echo e(number_format($data['total_assets'], 2)); ?></td>
        </tr>
        <tr>
            <td>TOTAL LIABILITIES + EQUITY</td>
            <td class="num">Rs. <?php echo e(number_format($data['total_liabilities_equity'], 2)); ?></td>
        </tr>
    </table>

    <?php $diff = round($data['total_assets'] - $data['total_liabilities_equity'], 2); ?>
    <div class="balance-check <?php echo e(abs($diff) < 0.01 ? 'balance-ok' : 'balance-bad'); ?>">
        <?php echo e(abs($diff) < 0.01 ? '✓ Assets equal Liabilities + Equity — the books balance.' : '✗ Out of balance by Rs. ' . number_format(abs($diff), 2) . '.'); ?>
...
<?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\pdf\balance-sheet.blade.php ENDPATH**/ ?>