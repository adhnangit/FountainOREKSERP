...
<body>
            ...
            <tr>
                <td style="vertical-align:top; width:56%">
                    ...
                    <div class="company-address">
                        <strong style="color:#222"><?php echo e($po->branch->name); ?></strong>
                        <?php if($po->branch->address): ?><br><?php echo e($po->branch->address); ?><?php endif; ?>
                        <?php if($po->branch->phone): ?><br>Tel: <?php echo e($po->branch->phone); ?><?php endif; ?>
                        <?php if($po->branch->email): ?><br><?php echo e($po->branch->email); ?><?php endif; ?>
                    </div>
                    <?php endif; ?>
                </td>
    ...
    <table class="status-row-table">
        <tr>
            <td>
                <span class="badge badge-<?php echo e($po->status); ?>">
                    <?php echo e(ucfirst(str_replace('_', ' ', $po->status))); ?>
            ...
            <td style="text-align:right">
                <?php if($po->createdBy): ?>
                    ...
                    <span style="font-size:8.5px;font-weight:700;color:#111"><?php echo e($po->createdBy->name); ?></span>
                <?php endif; ?>
                <?php if($po->payment_terms_days): ?>
                    &nbsp;&nbsp;
                    <span style="font-size:8px;color:#5a6678">Terms:&nbsp;</span>
                    <span style="font-size:8.5px;font-weight:700;color:#111"><?php echo e($po->payment_terms_days); ?> days</span>
                <?php endif; ?>
            </td>
        </tr>
    </table>
    ...
    <table class="meta-outer">
        <tr>
            <td class="meta-box" style="width:48%">
                ...
                <div class="meta-primary-name"><?php echo e($po->supplier->name); ?></div>
                <?php if($po->supplier->company): ?>
                    <div class="meta-detail"><?php echo e($po->supplier->company); ?></div>
                <?php endif; ?>
                <?php if($po->supplier->address): ?>
                    <div class="meta-detail"><?php echo e($po->supplier->address); ?></div>
                <?php endif; ?>
                <?php if($po->supplier->phone): ?>
                    <div class="meta-detail">Tel: <?php echo e($po->supplier->phone); ?></div>
                <?php endif; ?>
            </td>
            ...
            <td class="meta-box-right" style="width:48%">
                ...
                <table class="detail-inner">
                    ...
                    <tr>
                        ...
                        <td class="dv"><?php echo e($po->expected_date->format('d M Y')); ?></td>
                    </tr>
                    <?php endif; ?>
                    <?php if($po->due_date): ?>
                    <tr>
                        <td class="dk">Due Date</td>
                        <td class="dv"><?php echo e($po->due_date->format('d M Y')); ?></td>
                    </tr>
                    <?php endif; ?>
                    <?php if($po->reference): ?>
                    <tr>
                        <td class="dk">Reference</td>
                        <td class="dv"><?php echo e($po->reference); ?></td>
                    </tr>
                    <?php endif; ?>
                    <?php if($po->branch): ?>
                    <tr>
                        <td class="dk">Branch</td>
                        <td class="dv"><?php echo e($po->branch->name); ?></td>
                    </tr>
                    <?php endif; ?>
                </table>
            </td>
            ...
            <td class="totals-right">
                <table class="totals-inner">
                    ...
                    <tr>
                        ...
                        <td class="tv"><?php echo e(number_format($po->subtotal, 2)); ?></td>
                    </tr>
                    <tr>
                        <td class="tl">Discount</td>
                        <td class="tv">- <?php echo e(number_format($po->discount_amount, 2)); ?></td>
                    </tr>
                    <?php endif; ?>
                    <?php if($po->tax_amount > 0): ?>
                    <tr>
                        <td class="tl">Tax</td>
                        <td class="tv"><?php echo e(number_format($po->tax_amount, 2)); ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr class="trow-grand">
                        <td class="tl">Total</td>
                        <td class="tv">LKR <?php echo e(number_format($po->total, 2)); ?></td>
                    </tr>
                    <?php if($po->paid_amount > 0): ?>
                    <tr>
                        <td class="tl">Amount Paid</td>
                        <td class="tv">- <?php echo e(number_format($po->paid_amount, 2)); ?></td>
                    </tr>
                    <tr class="trow-balance">
                        <td class="tl">Balance Due</td>
                        <td class="tv">LKR <?php echo e(number_format($po->balance_due, 2)); ?></td>
                    </tr>
                    <?php endif; ?>
                </table>
            </td>
    ...
    <!-- NOTES / TERMS -->
    <?php if($po->notes || $po->terms): ?>
    <div class="notes-terms">
        <?php if($po->notes): ?>
            <h4>Notes</h4>
            <p><?php echo e($po->notes); ?></p>
        <?php endif; ?>
        <?php if($po->terms): ?>
            <h4 style="margin-top:6px">Terms &amp; Conditions</h4>
            <p><?php echo e($po->terms); ?></p>
        <?php endif; ?>
    </div>
    <?php endif; ?>
...
<?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\pdf\purchase-order.blade.php ENDPATH**/ ?>