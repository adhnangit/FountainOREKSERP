<?php $__env->startSection('title', 'Convert Proforma to Invoice'); ?>
<?php $__env->startSection('page-title', 'Convert to Invoice'); ?>
<?php $__env->startSection('page-desc', 'Review, edit and confirm the proforma invoice'); ?>
...
<style>
  ...
  .search-dd-menu {
    ...
    box-shadow:0 8px 30px rgba(0,0,0,0.12); z-index:60; overflow:hidden;
  }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/medrilk/system.medri.lk/backend/resources/views/proforma/convert.blade.php ENDPATH**/ ?>