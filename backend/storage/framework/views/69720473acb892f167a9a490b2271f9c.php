...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'MedRi ERP'); ?></title>
  <script>
  ...
  <aside class="sidebar flex flex-col flex-shrink-0 transition-all duration-300 overflow-hidden"
    ...
    <div class="flex items-center flex-shrink-0 transition-all duration-300 px-3"
      ...
      <div x-show="sidebarOpen" class="py-2 flex justify-center w-full">
        <img src="<?php echo e(asset('backend/public/images/medri-logo.png')); ?>" alt="MedRi" style="height:40px;width:auto;object-fit:contain" />
      </div>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto overflow-x-hidden py-3 px-2 space-y-0.5">
      ...
      <a href="<?php echo e(url('/')); ?>"
         ...
         class="n-link <?php echo e(request()->is('/') || request()->is('dashboard*') ? 'active' : ''); ?>"
      ...
      <div x-show="hasPerm('invoices.view')">
        <button @click="sidebarOpen ? toggle('sales') : null"
                class="n-group <?php echo e($sec === 'sales' ? 'sec-active' : ''); ?>"
        ...
        <div x-show="open.sales && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/invoices')); ?>"          class="n-sub <?php echo e(request()->is('invoices*')          ? 'active' : ''); ?>">Invoices</a>
          <a href="<?php echo e(url('/proforma-invoices')); ?>" x-show="hasPerm('proforma.view')"
             class="n-sub <?php echo e(request()->is('proforma-invoices*') ? 'active' : ''); ?>">Proforma Invoices</a>
          <a href="<?php echo e(url('/sales-returns')); ?>"     class="n-sub <?php echo e(request()->is('sales-returns*')     ? 'active' : ''); ?>">Sales Returns</a>
        </div>
      </div>
      ...
      <div x-show="hasPerm('cheques.view')">
        <button @click="sidebarOpen ? toggle('cheques') : null"
                class="n-group <?php echo e($sec === 'cheques' ? 'sec-active' : ''); ?>"
                :class="sidebarOpen ? '' : 'collapsed-btn'">
          <div class="n-icon">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="open.cheques && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/cheques')); ?>"          class="n-sub <?php echo e(request()->routeIs('cheques.index')    ? 'active' : ''); ?>">Manage Cheque</a>
          <a href="<?php echo e(url('/cheques/calendar')); ?>" class="n-sub <?php echo e(request()->routeIs('cheques.calendar') ? 'active' : ''); ?>">Cheque Calendar</a>
          <a href="<?php echo e(url('/cheques/history')); ?>"  class="n-sub <?php echo e(request()->routeIs('cheques.history')  ? 'active' : ''); ?>">Track Cheque</a>
        </div>
      </div>
      ...
      <div x-show="hasPerm('purchase_orders.view')">
        <button @click="sidebarOpen ? toggle('procurement') : null"
                class="n-group <?php echo e($sec === 'procurement' ? 'sec-active' : ''); ?>"
                :class="sidebarOpen ? '' : 'collapsed-btn'">
          <div class="n-icon">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="open.procurement && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/purchase-orders')); ?>" class="n-sub <?php echo e(request()->is('purchase-orders*') ? 'active' : ''); ?>">Supplier Invoices</a>
          <a href="<?php echo e(url('/purchase-returns')); ?>" class="n-sub <?php echo e(request()->is('purchase-returns*') ? 'active' : ''); ?>">Purchase Returns</a>
        </div>
      </div>
      ...
      <div x-show="hasPerm('customers.view')">
        <button @click="sidebarOpen ? toggle('partners') : null"
                class="n-group <?php echo e($sec === 'partners' ? 'sec-active' : ''); ?>"
                :class="sidebarOpen ? '' : 'collapsed-btn'">
          <div class="n-icon">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="open.partners && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/customers')); ?>" class="n-sub <?php echo e(request()->is('customers*') ? 'active' : ''); ?>">Customers</a>
          <a href="<?php echo e(url('/suppliers')); ?>" class="n-sub <?php echo e(request()->is('suppliers*') ? 'active' : ''); ?>">Suppliers</a>
        </div>
      </div>
      ...
      <div x-show="hasPerm('inventory.view')">
        <button @click="sidebarOpen ? toggle('inventory') : null"
                class="n-group <?php echo e($sec === 'inventory' ? 'sec-active' : ''); ?>"
                :class="sidebarOpen ? '' : 'collapsed-btn'">
          <div class="n-icon">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="open.inventory && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/products')); ?>"              class="n-sub <?php echo e(request()->is('products*') && !request()->is('products/categories*') ? 'active' : ''); ?>">Products</a>
          <a href="<?php echo e(url('/products/categories')); ?>"   class="n-sub <?php echo e(request()->is('products/categories*')   ? 'active' : ''); ?>">Categories</a>
          <a href="<?php echo e(url('/inventory/transfers')); ?>"   class="n-sub <?php echo e(request()->is('inventory/transfers*')   ? 'active' : ''); ?>">Transfers</a>
          <a href="<?php echo e(url('/inventory/adjustments')); ?>" class="n-sub <?php echo e(request()->is('inventory/adjustments*') ? 'active' : ''); ?>">Adjustments</a>
          <a href="<?php echo e(url('/inventory/low-stock')); ?>"   class="n-sub <?php echo e(request()->is('inventory/low-stock*')   ? 'active' : ''); ?>">Low Stock</a>
        </div>
      </div>
      ...
      <div x-show="hasPerm('services.view')">
        <button @click="sidebarOpen ? toggle('services') : null"
                class="n-group <?php echo e($sec === 'services' ? 'sec-active' : ''); ?>"
                :class="sidebarOpen ? '' : 'collapsed-btn'">
          <div class="n-icon">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="open.services && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/services/categories')); ?>" class="n-sub <?php echo e(request()->is('services/categories*') ? 'active' : ''); ?>">Service Category</a>
          <a href="<?php echo e(url('/services')); ?>"             class="n-sub <?php echo e(request()->is('services*') && !request()->is('services/categories*') ? 'active' : ''); ?>">Manage Service</a>
        </div>
      </div>
      ...
      <div x-show="hasPerm('expenses.view')">
        <button @click="sidebarOpen ? toggle('finance') : null"
                class="n-group <?php echo e($sec === 'finance' ? 'sec-active' : ''); ?>"
                :class="sidebarOpen ? '' : 'collapsed-btn'">
          <div class="n-icon">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="open.finance && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/expenses')); ?>" class="n-sub <?php echo e(request()->is('expenses*') ? 'active' : ''); ?>">Manage Expenses</a>
        </div>
      </div>

      
      <a href="<?php echo e(url('/targets')); ?>" x-show="hasPerm('targets.view')"
         class="n-link <?php echo e(request()->is('targets*') ? 'active' : ''); ?>"
         :class="sidebarOpen ? '' : 'collapsed-link'">
        <div class="n-icon">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div x-show="hasPerm('accounting.view')">
        <button @click="sidebarOpen ? toggle('accounting') : null"
                class="n-group <?php echo e($sec === 'accounting' ? 'sec-active' : ''); ?>"
                :class="sidebarOpen ? '' : 'collapsed-btn'">
          <div class="n-icon">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="open.accounting && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/accounting/chart-of-accounts')); ?>" class="n-sub <?php echo e(request()->is('accounting/chart-of-accounts*') ? 'active' : ''); ?>">Chart of Accounts</a>
          <a href="<?php echo e(url('/accounting/journal')); ?>"           class="n-sub <?php echo e(request()->is('accounting/journal*')           ? 'active' : ''); ?>">Journal</a>
          <a href="<?php echo e(url('/accounting/trial-balance')); ?>"     class="n-sub <?php echo e(request()->is('accounting/trial-balance*')     ? 'active' : ''); ?>">Trial Balance</a>
          <a href="<?php echo e(url('/accounting/profit-loss')); ?>"       class="n-sub <?php echo e(request()->is('accounting/profit-loss*')       ? 'active' : ''); ?>">Profit &amp; Loss</a>
          <a href="<?php echo e(url('/accounting/balance-sheet')); ?>"     class="n-sub <?php echo e(request()->is('accounting/balance-sheet*')     ? 'active' : ''); ?>">Balance Sheet</a>
          <a href="<?php echo e(url('/accounting/ledger')); ?>"            class="n-sub <?php echo e(request()->is('accounting/ledger*')            ? 'active' : ''); ?>">General Ledger</a>
          <a href="<?php echo e(url('/accounting/settings')); ?>"          class="n-sub <?php echo e(request()->is('accounting/settings*')          ? 'active' : ''); ?>">Settings</a>
        </div>
      </div>

      
      <a href="<?php echo e(url('/calendar')); ?>" x-show="hasPerm('calendar.view')"
         class="n-link <?php echo e(request()->is('calendar*') ? 'active' : ''); ?>"
         :class="sidebarOpen ? '' : 'collapsed-link'">
        <div class="n-icon">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <a href="<?php echo e(url('/tasks')); ?>" x-show="hasPerm('tasks.view')"
         class="n-link <?php echo e(request()->is('tasks*') ? 'active' : ''); ?>"
         :class="sidebarOpen ? '' : 'collapsed-link'">
        <div class="n-icon">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div x-show="hasPerm('reports.view')">
        <button @click="sidebarOpen ? toggle('reports') : null"
                class="n-group <?php echo e($sec === 'reports' ? 'sec-active' : ''); ?>"
                :class="sidebarOpen ? '' : 'collapsed-btn'">
          <div class="n-icon">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="open.reports && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/reports')); ?>"                class="n-sub <?php echo e(request()->is('reports') ? 'active' : ''); ?>">All Reports</a>
          <a href="<?php echo e(url('/reports/sales')); ?>"          class="n-sub <?php echo e(request()->is('reports/sales*')          ? 'active' : ''); ?>">Sales</a>
          <a href="<?php echo e(url('/reports/purchase')); ?>"       class="n-sub <?php echo e(request()->is('reports/purchase*')       ? 'active' : ''); ?>">Purchases</a>
          <a href="<?php echo e(url('/reports/inventory')); ?>"      class="n-sub <?php echo e(request()->is('reports/inventory*')      ? 'active' : ''); ?>">Inventory</a>
          <a href="<?php echo e(url('/reports/customer-aging')); ?>" class="n-sub <?php echo e(request()->is('reports/customer-aging*') ? 'active' : ''); ?>">Customer Aging</a>
          <a href="<?php echo e(url('/reports/supplier-aging')); ?>" class="n-sub <?php echo e(request()->is('reports/supplier-aging*') ? 'active' : ''); ?>">Supplier Aging</a>
          <a href="<?php echo e(url('/reports/expenses')); ?>"       class="n-sub <?php echo e(request()->is('reports/expenses*')       ? 'active' : ''); ?>">Expenses</a>
          <a href="<?php echo e(url('/reports/cheques')); ?>"        class="n-sub <?php echo e(request()->is('reports/cheques*')        ? 'active' : ''); ?>">Cheques</a>
          <a href="<?php echo e(url('/reports/targets')); ?>"        class="n-sub <?php echo e(request()->is('reports/targets*')        ? 'active' : ''); ?>">Targets</a>
          <a href="<?php echo e(url('/reports/stock-movement')); ?>" class="n-sub <?php echo e(request()->is('reports/stock-movement*') ? 'active' : ''); ?>">Stock Movement</a>
        </div>
      </div>
      ...
      <div x-show="hasPerm('hr.employees.view') || hasPerm('hr.departments.view') || hasPerm('hr.designations.view') || hasPerm('hr.attendance.view') || hasPerm('hr.holidays.view') || hasPerm('hr.leave_requests.view') || hasPerm('hr.leave_balances.view') || hasPerm('hr.leave_types.view') || hasPerm('hr.payroll.view') || hasPerm('hr.jobs.view') || hasPerm('hr.candidates.view') || hasPerm('hr.performance.view') || hasPerm('hr.checklists.view') || hasPerm('hr.assets.view') || hasPerm('hr.reports.view')">
        <button @click="sidebarOpen ? toggle('hr') : null"
                class="n-group <?php echo e($sec === 'hr' ? 'sec-active' : ''); ?>"
                :class="sidebarOpen ? '' : 'collapsed-btn'">
          <div class="n-icon">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="open.hr && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/hr/employees')); ?>"     x-show="hasPerm('hr.employees.view')"
             class="n-sub <?php echo e(request()->is('hr/employees*') ? 'active' : ''); ?>">Employees</a>
          <a href="<?php echo e(url('/hr/org-chart')); ?>"      x-show="hasPerm('hr.employees.view')"
             class="n-sub <?php echo e(request()->is('hr/org-chart*') ? 'active' : ''); ?>">Org Chart</a>
          <a href="<?php echo e(url('/hr/attendance')); ?>"     x-show="hasPerm('hr.attendance.view')"
             class="n-sub <?php echo e(request()->is('hr/attendance*') ? 'active' : ''); ?>">Attendance</a>
          <a href="<?php echo e(url('/hr/holidays')); ?>"       x-show="hasPerm('hr.holidays.view')"
             class="n-sub <?php echo e(request()->is('hr/holidays*') ? 'active' : ''); ?>">Holidays</a>
          <a href="<?php echo e(url('/hr/leave-requests')); ?>" x-show="hasPerm('hr.leave_requests.view')"
             class="n-sub <?php echo e(request()->is('hr/leave-requests*') ? 'active' : ''); ?>">Leave Requests</a>
          <a href="<?php echo e(url('/hr/leave-balances')); ?>" x-show="hasPerm('hr.leave_balances.view')"
             class="n-sub <?php echo e(request()->is('hr/leave-balances*') ? 'active' : ''); ?>">Leave Balances</a>
          <a href="<?php echo e(url('/hr/leave-types')); ?>"    x-show="hasPerm('hr.leave_types.view')"
             class="n-sub <?php echo e(request()->is('hr/leave-types*') ? 'active' : ''); ?>">Leave Types</a>
          <a href="<?php echo e(url('/hr/payroll')); ?>"        x-show="hasPerm('hr.payroll.view')"
             class="n-sub <?php echo e(request()->is('hr/payroll*') ? 'active' : ''); ?>">Payroll</a>
          <a href="<?php echo e(url('/hr/job-openings')); ?>"   x-show="hasPerm('hr.jobs.view')"
             class="n-sub <?php echo e(request()->is('hr/job-openings*') ? 'active' : ''); ?>">Job Openings</a>
          <a href="<?php echo e(url('/hr/candidates')); ?>"     x-show="hasPerm('hr.candidates.view')"
             class="n-sub <?php echo e(request()->is('hr/candidates*') ? 'active' : ''); ?>">Candidates</a>
          <a href="<?php echo e(url('/hr/departments')); ?>"    x-show="hasPerm('hr.departments.view')"
             class="n-sub <?php echo e(request()->is('hr/departments*') ? 'active' : ''); ?>">Departments</a>
          <a href="<?php echo e(url('/hr/designations')); ?>"   x-show="hasPerm('hr.designations.view')"
             class="n-sub <?php echo e(request()->is('hr/designations*') ? 'active' : ''); ?>">Designations</a>
          <a href="<?php echo e(url('/hr/performance-cycles')); ?>" x-show="hasPerm('hr.performance.view')"
             class="n-sub <?php echo e(request()->is('hr/performance-cycles*') ? 'active' : ''); ?>">Performance Cycles</a>
          <a href="<?php echo e(url('/hr/performance-reviews')); ?>" x-show="hasPerm('hr.performance.view')"
             class="n-sub <?php echo e(request()->is('hr/performance-reviews*') ? 'active' : ''); ?>">Performance Reviews</a>
          <a href="<?php echo e(url('/hr/checklist-templates')); ?>" x-show="hasPerm('hr.checklists.view')"
             class="n-sub <?php echo e(request()->is('hr/checklist-templates*') ? 'active' : ''); ?>">Onboarding Templates</a>
          <a href="<?php echo e(url('/hr/assets')); ?>"         x-show="hasPerm('hr.assets.view')"
             class="n-sub <?php echo e(request()->is('hr/assets*') ? 'active' : ''); ?>">Assets</a>
          <a href="<?php echo e(url('/hr/reports')); ?>"        x-show="hasPerm('hr.reports.view')"
             class="n-sub <?php echo e(request()->is('hr/reports*') ? 'active' : ''); ?>">HR Reports</a>
        </div>
      </div>

      
      <a href="<?php echo e(url('/my')); ?>" x-show="user?.has_employee_record"
         class="n-link <?php echo e(request()->is('my*') ? 'active' : ''); ?>"
         :class="sidebarOpen ? '' : 'collapsed-link'">
        <div class="n-icon">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <a href="<?php echo e(url('/manager/team')); ?>" x-show="user?.is_manager"
         class="n-link <?php echo e(request()->is('manager*') ? 'active' : ''); ?>"
         :class="sidebarOpen ? '' : 'collapsed-link'">
        <div class="n-icon">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <a href="<?php echo e(url('/announcements')); ?>"
         class="n-link <?php echo e(request()->is('announcements*') ? 'active' : ''); ?>"
         :class="sidebarOpen ? '' : 'collapsed-link'">
        <div class="n-icon">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div x-show="hasPerm('users.view') || hasPerm('roles.view') || hasPerm('activity_log.view')">
        <button @click="sidebarOpen ? toggle('admin') : null"
                class="n-group <?php echo e($sec === 'admin' ? 'sec-active' : ''); ?>"
                :class="sidebarOpen ? '' : 'collapsed-btn'">
          <div class="n-icon">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div x-show="open.admin && sidebarOpen" class="n-sub-list">
          <a href="<?php echo e(url('/access-control/users')); ?>"        x-show="hasPerm('users.view')"
             class="n-sub <?php echo e(request()->is('access-control/users*')        ? 'active' : ''); ?>">Users</a>
          <a href="<?php echo e(url('/access-control/roles')); ?>"        x-show="hasPerm('roles.view')"
             class="n-sub <?php echo e(request()->is('access-control/roles*')        ? 'active' : ''); ?>">Roles</a>
          <a href="<?php echo e(url('/access-control/activity-log')); ?>" x-show="hasPerm('activity_log.view')"
             class="n-sub <?php echo e(request()->is('access-control/activity-log*') ? 'active' : ''); ?>">Activity Log</a>
          <a x-show="user?.roles?.includes('super_admin') || user?.roles?.includes('branch_manager')"
             href="<?php echo e(url('/settings/dashboard-widgets')); ?>"
             class="n-sub <?php echo e(request()->is('settings/dashboard-widgets*') ? 'active' : ''); ?>">Dashboard Widgets</a>
          <a x-show="user?.roles?.includes('super_admin')"
             href="<?php echo e(url('/settings/branches')); ?>"
             class="n-sub <?php echo e(request()->is('settings/branches*') ? 'active' : ''); ?>">Branches</a>
          <a href="<?php echo e(url('/settings/banks')); ?>"
             class="n-sub <?php echo e(request()->is('settings/banks*') ? 'active' : ''); ?>">Banks</a>
          <a href="<?php echo e(url('/settings/districts-cities')); ?>"
             class="n-sub <?php echo e(request()->is('settings/districts-cities*') ? 'active' : ''); ?>">Districts &amp; Cities</a>
        </div>
      </div>

      
      <a href="<?php echo e(url('/directory')); ?>" x-show="hasPerm('directory.view')"
         class="n-link <?php echo e(request()->is('directory*') ? 'active' : ''); ?>"
         :class="sidebarOpen ? '' : 'collapsed-link'">
        <div class="n-icon">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <a href="<?php echo e(url('/settings')); ?>" class="n-link <?php echo e(request()->is('settings*') ? 'active' : ''); ?>"
         :class="sidebarOpen ? '' : 'collapsed-link'">
        <div class="n-icon">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
  ...
  <div class="flex-1 flex flex-col overflow-hidden">
    ...
    <header class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 px-5 flex items-center justify-between flex-shrink-0"
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          <h1 class="text-[15px] font-semibold text-gray-800 dark:text-white leading-none"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
          <p class="text-[11px] text-gray-400 mt-0.5 hidden sm:block"><?php echo $__env->yieldContent('page-desc', ''); ?></p>
        </div>
      </div>
        ...
        <div class="relative" x-data="{ profileOpen: false }">
          ...
          <div x-show="profileOpen"
            ...
            <div class="py-1.5">
              ...
              <a href="<?php echo e(url('/access-control/activity-log')); ?>"
                 class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                 @click="profileOpen = false">
                <div class="w-7 h-7 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center">
                  <svg class="w-3.5 h-3.5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
async function apiFetch(path, opts = {}) {
  ...
  if (res.status === 401) { clearApiToken(); window.location.href = '<?php echo e(url('/login')); ?>'; return; }
  if (!res.ok) {
...
function layout() {
  return {
    ...
    open: {
      sales:       '<?php echo e($sec); ?>' === 'sales',
      cheques:     '<?php echo e($sec); ?>' === 'cheques',
      procurement: '<?php echo e($sec); ?>' === 'procurement',
      partners:    '<?php echo e($sec); ?>' === 'partners',
      inventory:   '<?php echo e($sec); ?>' === 'inventory',
      services:    '<?php echo e($sec); ?>' === 'services',
      finance:     '<?php echo e($sec); ?>' === 'finance',
      accounting:  '<?php echo e($sec); ?>' === 'accounting',
    ...
    logout() {
      apiFetch('/auth/logout', { method: 'POST' }).finally(() => { clearApiToken(); window.location.href = '<?php echo e(url('/login')); ?>'; });
    }
  };
}
</script>
...
<?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views/layouts/app.blade.php ENDPATH**/ ?>