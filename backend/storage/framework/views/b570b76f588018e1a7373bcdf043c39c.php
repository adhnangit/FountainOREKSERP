<?php $__env->startSection('title', 'Purchase Returns'); ?>
<?php $__env->startSection('page-title', 'Purchase Returns'); ?>
<?php $__env->startSection('page-desc', 'Debit notes issued for goods returned to suppliers'); ?>
<?php $sec = 'procurement'; ?>
...
<div x-data="purchaseReturnsPage()" x-init="init()">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(url('/purchase-returns/create')); ?>" class="btn-primary inline-flex items-center gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/medrilk/system.medri.lk/backend/resources/views/purchase/returns.blade.php ENDPATH**/ ?>