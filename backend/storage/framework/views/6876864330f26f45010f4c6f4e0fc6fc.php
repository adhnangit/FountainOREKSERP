...
<?php $__env->startSection('page-desc', 'Income and expenses for a selected period'); ?>
...
<div x-data="plPage()" x-init="init()">
  ...
  <div class="pl-toolbar">
    ...
    <div style="margin-left:auto" class="flex gap-2">
      <a href="<?php echo e(url('/accounting/trial-balance')); ?>"  class="pl-link">Trial Balance</a>
      <a href="<?php echo e(url('/accounting/balance-sheet')); ?>"  class="pl-link">Balance Sheet</a>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\accounting\profit-loss.blade.php ENDPATH**/ ?>