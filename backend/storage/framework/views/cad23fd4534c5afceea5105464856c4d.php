    ...
    return {
        ...
        eModal: {
            ...
            form: {
                ...
                all_day: false, location: '', description: '', is_company_wide: false,
        ...
        get filtered() {
            ...
            return this.items.filter(e => e.type === this.typeFilter);
        },
        ...
        openAddModal(dateStr) {
            this.eModal = {
                ...
                form: {
                    title: '', type: 'meeting', date: dateStr ?? todayStr, start_time: '', end_time: '',
                    all_day: false, location: '', description: '', is_company_wide: false,
                    recurrence: 'none', recurrence_days: [], recurrence_end_date: '', color: '#3b82f6',
                },
            };
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/medrilk/system.medri.lk/backend/resources/views/calendar/index.blade.php ENDPATH**/ ?>