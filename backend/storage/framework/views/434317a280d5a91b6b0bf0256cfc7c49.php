...
<?php $__env->startSection('page-title', 'Sales Returns'); ?>
<?php $__env->startSection('page-desc', 'Credit notes issued for returned goods'); ?>
<?php $sec = 'sales'; ?>
...
<div x-data="salesReturnsPage()" x-init="init()">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(url('/sales-returns/create')); ?>" class="btn-primary inline-flex items-center gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/medrilk/system.medri.lk/backend/resources/views/returns/index.blade.php ENDPATH**/ ?>