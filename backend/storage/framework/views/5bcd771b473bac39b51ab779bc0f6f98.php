...
<div x-data="trialBalancePage()" x-init="init()">
  ...
  <div class="tb-toolbar">
    ...
    <div style="margin-left:auto" class="flex gap-2">
      <a href="<?php echo e(url('/accounting/profit-loss')); ?>"   class="tb-link">P&amp;L</a>
      <a href="<?php echo e(url('/accounting/balance-sheet')); ?>" class="tb-link">Balance Sheet</a>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\accounting\trial-balance.blade.php ENDPATH**/ ?>