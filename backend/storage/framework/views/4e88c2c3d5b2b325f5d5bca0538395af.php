...
<body>
        ...
        <table class="header-table">
            <tr>
                <td style="vertical-align:top; width:56%">
                    <?php if($logoSrc): ?>
                        <img src="<?php echo e($logoSrc); ?>" style="height:42px; max-width:190px;" alt="<?php echo e(config('app.name', 'MEDRI')); ?>">
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <?php if($invoice->branch): ?>
                    <div class="company-address">
                        <strong style="color:#222"><?php echo e($invoice->branch->name); ?></strong>
                        <?php if($invoice->branch->address): ?><br><?php echo e($invoice->branch->address); ?><?php endif; ?>
                        <?php if($invoice->branch->phone): ?><br>Tel: <?php echo e($invoice->branch->phone); ?><?php endif; ?>
                        <?php if($invoice->branch->email): ?><br><?php echo e($invoice->branch->email); ?><?php endif; ?>
                    </div>
                    <?php endif; ?>
                </td>
                <td style="vertical-align:top; width:44%">
                    <div class="inv-type-label serif">
                        <?php if($invoice->type === 'proforma'): ?> Proforma Invoice
                        <?php else: ?> Invoice <?php endif; ?>
                    </div>
    ...
    <table class="status-row-table">
        <tr>
            <td>
                <span class="badge badge-<?php echo e($invoice->status); ?>">
                    <?php echo e(ucfirst(str_replace('_', ' ', $invoice->status))); ?>

                </span>
            </td>
            <td style="text-align:right">
                <?php if($invoice->salesRep ?? $invoice->createdBy): ?>
                    <span style="font-size:8px;color:#5a6678">Rep:&nbsp;</span>
                    <span style="font-size:8.5px;font-weight:700;color:#111">
                        <?php echo e(($invoice->salesRep ?? $invoice->createdBy)?->name); ?>

                    </span>
                <?php endif; ?>
                <?php if($invoice->payment_terms_days): ?>
                    &nbsp;&nbsp;
                    <span style="font-size:8px;color:#5a6678">Terms:&nbsp;</span>
                    <span style="font-size:8.5px;font-weight:700;color:#111"><?php echo e($invoice->payment_terms_days); ?> days</span>
                <?php endif; ?>
            </td>
        </tr>
    </table>
    ...
    <table class="meta-outer">
        <tr>
            <td class="meta-box" style="width:48%">
                ...
                <div class="meta-primary-name"><?php echo e($invoice->customer->name); ?></div>
                <?php if($invoice->customer->company): ?>
                    <div class="meta-detail"><?php echo e($invoice->customer->company); ?></div>
                <?php endif; ?>
                <?php if($invoice->customer->address): ?>
                    <div class="meta-detail"><?php echo e($invoice->customer->address); ?></div>
                <?php endif; ?>
                <?php if($invoice->customer->phone): ?>
                    <div class="meta-detail">Tel: <?php echo e($invoice->customer->phone); ?></div>
                <?php endif; ?>
            </td>
            ...
            <td class="meta-box-right" style="width:48%">
                ...
                <table class="detail-inner">
                    ...
                    <tr>
                        ...
                        <td class="dv"><?php echo e($invoice->due_date->format('d M Y')); ?></td>
                    </tr>
                    <?php endif; ?>
                    <?php if($invoice->reference_number): ?>
                    <tr>
                        <td class="dk">P.O. Number</td>
                        <td class="dv"><?php echo e($invoice->reference_number); ?></td>
                    </tr>
                    <?php endif; ?>
                    <?php if($invoice->branch): ?>
                    <tr>
                        <td class="dk">Branch</td>
                        <td class="dv"><?php echo e($invoice->branch->name); ?></td>
                    </tr>
                    <?php endif; ?>
                </table>
            </td>
    ...
    <table class="items-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="pname"><?php echo e($item->product_name); ?></div>
                    <?php if($item->batch_number): ?>
                        <div class="pnote">Batch: <?php echo e($item->batch_number); ?></div>
                    <?php endif; ?>
                </td>
                <td class="tr">
                    <?php echo e(rtrim(rtrim(number_format($item->quantity, 2), '0'), '.')); ?>

                </td>
                <td class="tr"><?php echo e(number_format($item->unit_price, 2)); ?></td>
                <td class="tr"><?php echo e(number_format($item->total, 2)); ?></td>
            </tr>
            ...
            <td class="totals-right">
                <table class="totals-inner">
                    ...
                    <tr>
                        ...
                        <td class="tv"><?php echo e(number_format($invoice->subtotal, 2)); ?></td>
                    </tr>
                    <tr>
                        <td class="tl">Discount</td>
                        <td class="tv">- <?php echo e(number_format($invoice->discount_amount, 2)); ?></td>
                    </tr>
                    <?php endif; ?>
                    <?php if($invoice->tax_amount > 0): ?>
                    <tr>
                        <td class="tl">Tax (<?php echo e($invoice->tax_percent); ?>%)</td>
                        <td class="tv"><?php echo e(number_format($invoice->tax_amount, 2)); ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr class="trow-grand">
                        <td class="tl">Total</td>
                        <td class="tv">LKR <?php echo e(number_format($invoice->total, 2)); ?></td>
                    </tr>
                    <?php if($invoice->paid_amount > 0): ?>
                    <tr>
                        <td class="tl">Amount Paid</td>
                        <td class="tv">- <?php echo e(number_format($invoice->paid_amount, 2)); ?></td>
                    </tr>
                    <tr class="trow-balance">
                        <td class="tl">Balance Due</td>
                        <td class="tv">LKR <?php echo e(number_format($invoice->balance_due, 2)); ?></td>
                    </tr>
                    <?php endif; ?>
                </table>
            </td>
    ...
    <!-- FOOTER NOTE -->
    <?php if($footerNote): ?>
    <div class="footer-note-box"><?php echo e($footerNote); ?></div>
    <?php endif; ?>

    <!-- BANK / PAYMENT DETAILS -->
    <?php if($bankDetails): ?>
    <div class="bank-details"><?php echo nl2br(e($bankDetails)); ?></div>
    <?php endif; ?>
    ...
    <table class="signature-table">
        <tr>
            <td class="signature-cell">
                <div class="signature-line"><?php echo e($sigLabels[0]); ?></div>
            </td>
            <td class="signature-cell">
                <div class="signature-line"><?php echo e($sigLabels[1]); ?></div>
            </td>
            <td class="signature-cell">
                <div class="signature-line"><?php echo e($sigLabels[2]); ?></div>
            </td>
        </tr>
    </table>
...
<?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\pdf\invoice.blade.php ENDPATH**/ ?>