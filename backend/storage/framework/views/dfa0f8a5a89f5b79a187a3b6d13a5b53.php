<?php $__env->startSection('title', 'Proforma Invoice'); ?>
<?php $__env->startSection('page-title', 'Proforma Invoice'); ?>
<?php $__env->startSection('page-desc', 'View and manage this draft invoice'); ?>
    ...
    <div class="max-w-4xl mx-auto space-y-5">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div class="flex items-center gap-3">
          <a href="<?php echo e(url('/proforma-invoices')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\proforma\show.blade.php ENDPATH**/ ?>