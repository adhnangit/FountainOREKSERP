...
<?php $__env->startSection('page-title', 'Balance Sheet'); ?>
<?php $__env->startSection('page-desc', 'Assets, liabilities, and equity at a point in time'); ?>
...
<div x-data="balanceSheetPage()" x-init="init()">
  ...
  <div class="bs-toolbar">
    ...
    <div style="margin-left:auto" class="flex gap-2">
      <a href="<?php echo e(url('/accounting/trial-balance')); ?>" class="bs-link">Trial Balance</a>
      <a href="<?php echo e(url('/accounting/profit-loss')); ?>"   class="bs-link">P&amp;L</a>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\accounting\balance-sheet.blade.php ENDPATH**/ ?>