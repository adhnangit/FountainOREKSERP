...
<?php $__env->startSection('page-desc', 'Organize products into categories'); ?>
<?php $sec = 'inventory'; ?>
                ...
                <template x-for="cat in categories" :key="cat.id">
                    <template x-for="row in [cat, ...(cat.children||[])]" :key="row.id">
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20">
                            ...
                            <td class="table-td text-gray-500" x-text="row.products_count ?? '—'"></td>
                            <td class="table-td">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/medrilk/system.medri.lk/backend/resources/views/products/categories.blade.php ENDPATH**/ ?>