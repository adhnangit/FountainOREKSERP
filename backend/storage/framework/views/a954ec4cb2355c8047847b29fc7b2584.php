...
<?php $__env->startSection('page-title', 'Payroll Run'); ?>
<?php $__env->startSection('page-desc', 'Review payslips for this period'); ?>
<?php $sec = 'hr'; ?>
...
<div x-data="payrollShowPage()" x-init="init()">
    ...
    <div x-show="!loading" x-cloak>
        <a href="<?php echo e(url('/hr/payroll')); ?>" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 mb-4 transition-colors">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\hr\payroll-show.blade.php ENDPATH**/ ?>