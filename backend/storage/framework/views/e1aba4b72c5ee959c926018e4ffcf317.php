...
function rolesPage() {
    return {
        ...
        categories: [
            ...
            { key: 'collab',      label: 'Calendar & Directory',  icon: '📅', color: '#6b7280', bg: '#f9fafb', prefix: ['calendar','directory'] },
            { key: 'task_manager', label: 'Task Manager',         icon: '✅', color: '#4f46e5', bg: '#eef2ff', prefix: ['task_manager'] },
            { key: 'inquiries',   label: 'Inquiries & Leads',     icon: '📞', color: '#be123c', bg: '#fff1f2', prefix: ['inquiries'] },
        ...
        permLabel(name) {
            const labels = {
                ...
                'task_manager.view':'View Task Manager','task_manager.manage':'Manage Tasks',
                'task_manager.categories.manage':'Manage Task Categories',
                'inquiries.view':'View Inquiries & Leads','inquiries.manage':'Manage Inquiries & Leads',
                'inquiries.settings.manage':'Manage Inquiry Subjects/Statuses',
