...
<?php $__env->startSection('page-desc', 'Customer information, invoices and ledger'); ?>
...
<div x-data="customerShowPage()" x-init="init()">
    ...
    <div x-show="!loading" x-cloak>
        <a href="<?php echo e(url('/customers')); ?>" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 mb-4 transition-colors">
...
function customerShowPage() {
    ...
    return {
        ...
        districtCities,
        districtList: Object.keys(districtCities),
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/medrilk/system.medri.lk/backend/resources/views/customers/show.blade.php ENDPATH**/ ?>