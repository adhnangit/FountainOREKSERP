...
<?php $__env->startSection('page-desc', 'Manage your supplier accounts'); ?>
...
<div x-data="suppliersPage()" x-init="init()">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        ...
        <a href="<?php echo e(url('/suppliers/create')); ?>" class="btn-primary inline-flex items-center gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/medrilk/system.medri.lk/backend/resources/views/suppliers/index.blade.php ENDPATH**/ ?>