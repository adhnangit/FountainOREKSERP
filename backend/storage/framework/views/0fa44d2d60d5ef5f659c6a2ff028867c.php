...
<div x-data="supplierInvListPage()" x-init="init()">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
        ...
        <a href="<?php echo e(url('/purchase-orders/create')); ?>" class="btn-primary inline-flex items-center gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/medrilk/system.medri.lk/backend/resources/views/purchase/orders.blade.php ENDPATH**/ ?>