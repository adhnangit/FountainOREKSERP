...
<?php $__env->startSection('page-desc', 'Business intelligence and analytics'); ?>
...
<div x-data="reportsHub()" x-init="init()">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
    ...
    <a href="<?php echo e(route('reports.sales')); ?>" class="card group hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer">
    ...
    <a href="<?php echo e(route('reports.purchase')); ?>" class="card group hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer">
    ...
    <a href="<?php echo e(route('reports.inventory')); ?>" class="card group hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer">
    ...
    <a href="<?php echo e(route('reports.stock-movement')); ?>" class="card group hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer">
    ...
    <a href="<?php echo e(route('reports.customer-aging')); ?>" class="card group hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer">
    ...
    <a href="<?php echo e(route('reports.supplier-aging')); ?>" class="card group hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer">
    ...
    <a href="<?php echo e(route('reports.expenses')); ?>" class="card group hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer">
    ...
    <a href="<?php echo e(route('reports.cheques')); ?>" class="card group hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer">
    ...
    <a href="<?php echo e(route('reports.targets')); ?>" class="card group hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\reports\index.blade.php ENDPATH**/ ?>