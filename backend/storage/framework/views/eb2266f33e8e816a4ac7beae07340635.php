...
<?php $__env->startSection('page-title', 'New Stock Adjustment'); ?>
<?php $__env->startSection('page-desc', 'Record a manual stock adjustment'); ?>
...
<div x-data="adjustmentCreate()" x-init="init()" x-cloak>
  ...
  <div class="max-w-2xl mx-auto space-y-5">
    ...
    <div class="flex items-center gap-3">
      <a href="<?php echo e(url('/inventory/adjustments')); ?>" class="text-gray-400 hover:text-gray-600 transition-colors">
    ...
    <div class="flex items-center justify-end gap-3 pb-6">
      <a href="<?php echo e(url('/inventory/adjustments')); ?>" class="btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\inventory\adjustments-create.blade.php ENDPATH**/ ?>