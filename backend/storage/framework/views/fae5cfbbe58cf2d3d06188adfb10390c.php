...
<div x-data="ledgerPage()" x-init="init()">
  ...
  <div class="lg-toolbar">
    ...
    <div style="margin-left:auto" class="flex gap-2">
      <a href="<?php echo e(url('/accounting/trial-balance')); ?>" class="lg-link">Trial Balance</a>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\FountainOREKS\backend\resources\views\accounting\ledger.blade.php ENDPATH**/ ?>